...
import { PLACEHOLDER_AVATAR_SM } from '../data/placeholders';

export default function Navbar({ balance, onLogin, onRegister, user, onLogout }) {
  const handleLogout = () => {
    onLogout();
  };
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <>
                ...
                >
                  <img
                    src={user.avatar || PLACEHOLDER_AVATAR_SM}
                    alt={user.name}
